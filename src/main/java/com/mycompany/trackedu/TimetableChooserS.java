 ...
 * @author divya
 */
public class TimetableChooserS extends javax.swing.JFrame {

    /**
     * Creates new form TimetableChooserS
     */
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        SwingUtilities.invokeLater(() -> {
            TimetableViewerB viewer = new TimetableViewerB();
            viewer.setVisible(true);  // Ensure frame is set to visible
        });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TimetableChooserS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
